        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/auth/register?role=OWNER" className="hover:text-white transition-colors">
                  Разместить катер
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/legal/oferta" className="hover:text-white transition-colors">
                  Публичная оферта
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <a
                ...
                aria-label="Telegram"
                className="text-slate-400 hover:text-[#26A5E4] transition-colors"
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.247-2.042 9.617c-.153.682-.554.849-1.123.527l-3.098-2.283-1.495 1.438c-.165.165-.304.304-.624.304l.222-3.162 5.763-5.203c.25-.222-.054-.346-.389-.124L7.64 14.786l-3.055-.946c-.668-.208-.68-.668.14-.989l10.895-4.2c.557-.2 1.044.124.942.596z" />
                </svg>
              </a>
