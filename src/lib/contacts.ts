...
export const CONTACTS = {
  telegram: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/+96393CVvdEw5OGIy',
  whatsapp: process.env.NEXT_PUBLIC_CONTACT_WHATSAPP || 'https://chat.whatsapp.com/DK7iOZVpZ4u9QSXTh9uUvL',
